...
class TM_EPO_HTML {
	...
	public function tm_make_select($selectArray ,$optionArray , $selectedvalue="/n",$label=1,$ech=1){		
		...
		$class 		= (isset($selectArray['class']))?" class='".$selectArray['class']."'":"";
		$id 		= (isset($selectArray['id']))?" id='".$selectArray['id']."'":"";
		$name 		= (isset($selectArray['name']))?" name='".$selectArray['name']."'":"";
		$extra 		= (isset($selectArray['extra']))?" ".$selectArray['extra']:"";
